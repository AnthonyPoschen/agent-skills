...
| Ticket execution, commits, review, releases | `implement-tickets`, `git-commit-workflow`, and `release` | Covered, with better safety for this library. Pstack's central [mode and playbooks](https://github.com/cursor/plugins/blob/46125561306434d8a1d7745d540d8932ab0cd2a2/pstack/README.md) assume a particular Cursor and Graphite workflow. |
